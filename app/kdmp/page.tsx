                        ...
                        <div className="space-y-6 md:space-y-8">
                            <div className="space-y-4">
                                ...
                                <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight">
                                    ...
                                    <br />
                                    <span className="text-sky-200"> KDMP/KKMP</span>
                                </h1>
                                <p className="text-lg md:text-xl text-sky-100 leading-relaxed">
                                    Berdasarkan Peraturan Menteri Desa dan Pembangunan Daerah Tertinggal Republik Indonesia
                                    Nomor 10 Tahun 2025 tentang Kredit Koperasi Desa Mitra Perekonomian (KDMP), program
                                    ini memberikan kesempatan besar bagi koperasi desa untuk mengakses pembiayaan dari PT
