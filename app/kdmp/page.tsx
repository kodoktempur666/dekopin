                        ...
                        <div className="space-y-8">
                            ...
                            <div className='mt-8 hidden flex-wrap gap-4 lg:flex'>
                                <Badge className='flex items-center gap-2 border-green-500 bg-green-500 text-base text-white hover:bg-green-300'>
                                    ...
                                    Membekali keterampilan pengurus.
                                </Badge>
                                <Badge className='flex items-center gap-2 border-green-500 bg-green-500 text-base text-white hover:bg-green-300'>
                                    <CircleCheckBig size={20} />
                                    Memfasilitasi pengajuan pinjaman.
                                </Badge>
                                <Badge className='flex items-center gap-2 border-green-500 bg-green-500 text-base text-white hover:bg-green-300'>
                                    <CircleCheckBig size={20} />
                                ...
                                <Badge className='flex items-center gap-2 border-green-500 bg-green-500 text-base text-white hover:bg-green-300'>
                                    <CircleCheckBig size={20} />
                                    Memastikan kemampuan membayar angsuran.
                                </Badge>
                                <Badge className='flex items-center gap-2 border-green-500 bg-green-500 text-base text-white hover:bg-green-300'>
                                    <CircleCheckBig size={20} />
                        ...
                        <div className='flex flex-col overflow-hidden col-span-4 justify-start  bg-sky-50 p-8'>
                            ...
                            <ul className='list-disc pl-5 mt-10 space-y-2'>
                                <li>
                                    ...
                                    <p className='text-base '>Pencairan dana belanja modal, operasional bisnis, pelatihan pemasaran, dan manajemen SDM.</p>
                                </li>
                                <li>
                                    <p className='text-sm font-bold'>Bulan 9-12: Pemantauan & Angsuran Masa Tenggang</p>
                                    <p className='text-base '>Pembayaran bunga bulanan, monitoring kinerja, pencatatan keuangan, dan pelatihan lanjutan.</p>
                                </li>
                            </ul>
                        ...
                        {phases.map((phase, index) => (
                            <div key={phase.id} className="relative mb-12 last:mb-0">
                                ...
                                <div className="absolute left-1/2 transform -translate-x-1/2 flex items-center justify-center">
                                    <div className={`w-12 h-12 rounded-full ${phase.color} flex items-center justify-center text-white font-bold text-lg shadow-lg`}>
                                        {phase.id}
                                    </div>
                                </div>
                                ...
                                <div className={`flex items-center ${index % 2 === 0 ? 'justify-start' : 'justify-end'}`}>
                                    <div className={`w-5/12 ${index % 2 === 0 ? 'pr-8 text-right' : 'pl-8 text-left'}`}>
                                        <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-gray-200 hover:shadow-lg transition-shadow duration-300">
